...
namespace PostComment
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Post", Namespace="http://schemas.datacontract.org/2004/07/PostComment", Reference=true)]
    public partial class Post : object, System.Runtime.Serialization.IExtensibleDataObject
    {
        
        private System.Runtime.Serialization.ExtensionDataObject extensionDataField;
        
        private PostComment.Comments[] CommentsField;
        ...
        public PostComment.Comments[] Comments
        {
            get
            {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="Comments", Namespace="http://schemas.datacontract.org/2004/07/PostComment", IsReference=true)]
...
public interface IPostComment
{
    ...
    bool AddComment(PostComment.Comments comment);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfaceComment/AddComment", ReplyAction="http://tempuri.org/InterfaceComment/AddCommentResponse")]
    System.Threading.Tasks.Task<bool> AddCommentAsync(PostComment.Comments comment);
    ...
    PostComment.Comments UpdateComment(PostComment.Comments newComment);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfaceComment/UpdateComment", ReplyAction="http://tempuri.org/InterfaceComment/UpdateCommentResponse")]
    System.Threading.Tasks.Task<PostComment.Comments> UpdateCommentAsync(PostComment.Comments newComment);
    ...
    PostComment.Comments GetCommentById(int id);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/InterfaceComment/GetCommentById", ReplyAction="http://tempuri.org/InterfaceComment/GetCommentByIdResponse")]
    System.Threading.Tasks.Task<PostComment.Comments> GetCommentByIdAsync(int id);
}
...
public partial class PostCommentClient : System.ServiceModel.ClientBase<IPostComment>, IPostComment
{
    ...
    public bool AddComment(PostComment.Comments comment)
    {
        return base.Channel.AddComment(comment);
    }
    
    public System.Threading.Tasks.Task<bool> AddCommentAsync(PostComment.Comments comment)
    {
        return base.Channel.AddCommentAsync(comment);
    }
    
    public PostComment.Comments UpdateComment(PostComment.Comments newComment)
    {
        return base.Channel.UpdateComment(newComment);
    }
    
    public System.Threading.Tasks.Task<PostComment.Comments> UpdateCommentAsync(PostComment.Comments newComment)
    {
        return base.Channel.UpdateCommentAsync(newComment);
    }
    
    public PostComment.Comments GetCommentById(int id)
    {
        return base.Channel.GetCommentById(id);
    }
    
    public System.Threading.Tasks.Task<PostComment.Comments> GetCommentByIdAsync(int id)
    {
